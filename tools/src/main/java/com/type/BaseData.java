...
public class BaseData implements Serializable {
	...
	public Map<String, String> projectMap = new HashMap<String, String>() {
		private static final long serialVersionUID = -1343692398038233569L;
		{
			...
			put("EGFR 18、19、20、21外显子突变检测（组织）", "单基因突变检测");
			put("EGFR 18、19、20、21外显子突变检测（血液）", "单基因突变检测");
			put("EGFR T790M突变检测（血液）", "单基因突变检测");
			put("KRAS code12，13突变检测（组织）", "单基因突变检测");
			put("KRAS code12，13突变检测（血液）", "单基因突变检测");
			put("NRAS code12,13,61突变检测（组织）", "单基因突变检测");
			put("BRAF V600E突变检测（组织）", "单基因突变检测");
			put("BRAF V600E突变检测（血液）", "单基因突变检测");
			put("PDGFRα基因突变分析", "单基因突变检测");
			put("C-KIT基因突变分析", "单基因突变检测");
			put("结直肠癌基础套餐（四基因kras/nras/braf/pik3ca）", "一代套餐");
			put("脑胶质瘤套餐8项", "一代套餐");
			put("脑胶质瘤套餐7项", "一代套餐");
			...
			put("胰腺癌化疗套餐", "化疗套餐");
			put("子宫颈癌化疗套餐", "化疗套餐");
			put("UGT1A1基因多态性分析", "单基因检测");
			put("循环肿瘤细胞计数", "循环肿瘤细胞检测");
			put("循环肿瘤细胞PD-L1表达检测", "循环肿瘤细胞检测");
			put("循环肿瘤细胞C-MET表达检测", "循环肿瘤细胞检测");
			put("ALK蛋白表达水平检测", "IHC相关检测");
			put("BCL-2蛋白表达水平检测", "IHC相关检测");
			put("BCL-6蛋白表达水平检测", "IHC相关检测");
			put("CD3蛋白表达水平检测", "IHC相关检测");
			put("CD4蛋白表达水平检测", "IHC相关检测");
			put("CD5蛋白表达水平检测", "IHC相关检测");
			put("CD8蛋白表达水平检测", "IHC相关检测");
			put("CD9蛋白表达水平检测", "IHC相关检测");
			put("CD19蛋白表达水平检测", "IHC相关检测");
			put("CD20蛋白表达水平检测", "IHC相关检测");
			put("CD40蛋白表达水平检测", "IHC相关检测");
			put("CD117蛋白表达水平检测", "IHC相关检测");
			put("c-MYC蛋白表达水平检测", "IHC相关检测");
			put("HER2蛋白表达水平检测", "IHC相关检测");
			put("DLL3蛋白表达水平检测", "IHC相关检测");
			put("B-tubulin III蛋白表达水平检测", "IHC相关检测");
			put("ERCC1蛋白表达水平检测", "IHC相关检测");
			put("GFAP蛋白表达水平检测", "IHC相关检测");
			put("Ki-67蛋白表达水平检测", "IHC相关检测");
			put("PD-1蛋白表达水平检测", "IHC相关检测");
			put("PD-L1蛋白表达水平检测", "IHC相关检测");
			put("PDGFRB蛋白表达水平检测", "IHC相关检测");
			put("RET蛋白表达水平检测", "IHC相关检测");
			put("ROS1蛋白表达水平检测", "IHC相关检测");
			put("RRM1蛋白表达水平检测", "IHC相关检测");
			put("STMN1蛋白表达水平检测", "IHC相关检测");
			put("SPARC蛋白表达水平检测", "IHC相关检测");
			put("TOPO I蛋白表达水平检测", "IHC相关检测");
			put("TOPO IIa蛋白表达水平检测", "IHC相关检测");
			put("TFE3蛋白表达水平检测", "IHC相关检测");
			put("TS蛋白表达水平检测", "IHC相关检测");
			put("TSC1蛋白表达水平检测", "IHC相关检测");
			put("TSC2蛋白表达水平检测", "IHC相关检测");
			put("VEGFR1蛋白表达水平检测", "IHC相关检测");
			put("VEGFR2蛋白表达水平检测", "IHC相关检测");
			put("VEGFR3蛋白表达水平检测", "IHC相关检测");
			put("MMR蛋白表达水平检测", "IHC相关检测");
			put("ATRX蛋白表达水平检测", "IHC相关检测");
			put("ER蛋白表达水平检测", "IHC相关检测");
			put("PR蛋白表达水平检测", "IHC相关检测");
			put("p16蛋白表达水平检测", "IHC相关检测");
			put("PTEN蛋白表达水平检测", "IHC相关检测");
			put("EGFR蛋白表达水平检测", "IHC相关检测");
			put("HER2基因扩增检测", "IHC相关检测");
			put("ALK基因重排检测", "IHC相关检测");
			put("ROS1基因重排检测", "IHC相关检测");
			put("MET基因扩增检测", "IHC相关检测");
			put("EGFR基因扩增检测", "IHC相关检测");
			put("RET（10q11）基因重排检测", "IHC相关检测");
			put("SS18（SYT）基因重排检测", "IHC相关检测");
			put("EWSR1基因重排检测", "IHC相关检测");
			put("TFE3基因重排检测", "IHC相关检测");
			put("BCR/ABL基因融合检测", "IHC相关检测");
			put("1p/19q基因缺失检测", "IHC相关检测");
			put("NTRK1基因重排检测", "IHC相关检测");
			put("NTRK2基因重排检测", "IHC相关检测");
			put("NTRK3基因重排检测", "IHC相关检测");
			put("MDM2基因扩增检测", "IHC相关检测");
			put("一代测序单位点验证", "其他检测项目");
			put("肿瘤26基因+TMB+PD-L1 NGS Panel（组织）", "地级市panel");
			put("肿瘤26基因+TMB NGS Panel（血液）", "地级市panel");
			put("肺癌初治7基因快速检测Panel（PCR）", "地级市panel");
			...
			put("儿童肿瘤基因检测全覆盖panel（203基因）", "NGS套餐");
			put("化疗相关检测套餐", "化疗套餐");
			put("胃肠道肿瘤163基因", "其他检测项目");
		}
	};
